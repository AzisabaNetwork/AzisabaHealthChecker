...
public class ZoneSet implements Iterable<ZoneConfig> {
    private static final Logger LOGGER = LogManager.getLogger();
    private final List<ZoneConfig> servers = new ArrayList<>();
    ...
    public void read(@NotNull YamlObject obj) {
        try {
            servers.add(ZoneConfig.read(obj));
    ...
    @NotNull
    @Override
    public Iterator<ZoneConfig> iterator() {
